        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                _options = new MqttClientOptionsBuilder()
                    ...
                    .WithTcpServer("192.168.0.3", 1884)
                ...
                _client.UseConnectedHandler(e =>
                {
                    ...
                    //Subscribe to topic
                    _client.SubscribeAsync(new TopicFilterBuilder().WithTopic("esp8266").Build()).Wait();
                });
                ...
                _client.UseApplicationMessageReceivedHandler(e =>
                {
                    ...
                    DHT11 dht = JsonSerializer.Deserialize<DHT11>(Encoding.UTF8.GetString(e.ApplicationMessage.Payload));
                    Console.WriteLine($"+ Влажность = {dht.Humitidy} %");
                    Console.WriteLine($"+ Температура = {dht.Temperature} C");
